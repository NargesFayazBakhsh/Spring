...
public class WebConfig implements WebMvcConfigurer {
    ...
    @Bean    
    View registerform1(){
        return new JstlView("/WEB-INF/Q1/registerform1.jsp");
    }

    
    @Bean    
    View result1(){
        return new JstlView("/WEB-INF/Q1/result1.jsp");
    } 
    
    @Bean    
    View registerform2(){
        return new JstlView("/WEB-INF/Q2/registerform2.jsp");
    }

    
    @Bean    
    View result2(){
        return new JstlView("/WEB-INF/Q2/result2.jsp");
    }    
   
    
    @Bean    
    View registerform3(){
        return new JstlView("/WEB-INF/Q3/registerform3.jsp");
    }

    
    @Bean    
    View result3(){
        return new JstlView("/WEB-INF/Q3/result3.jsp");
    }        
